...
f1()
tableInit();});});function tabOfcontentButton(){var button=document.getElementById("tab-of-content-button");var html=button.innerHTML;var tableOfContents=document.getElementById("TableOfContents");if("关闭"==html){button.innerHTML="开启";tableOfContents.style.visibility="hidden";}else{button.innerHTML="关闭";tableOfContents.style.visibility="visible";}}
function tableInit(){var contentArea=document.getElementById("tab-of-content-area");try{var tableOfContents=document.getElementById("TableOfContents");var text=tableOfContents.innerText;if(text){contentArea.style.visibility="visible";}else{contentArea.style.visibility="hidden";}}catch(e){contentArea.style.visibility="hidden";}}
